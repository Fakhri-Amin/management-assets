...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="#">aset Lainnya</a></li>
    ...
    <div class="card mb-4">
        <div class="card-header text-center">
            ...
            Data Aset Lainnya
            <a class="btn btn-primary btn-sm float-end" href="/aset_lainnya/create">
                ...
                <tbody>
                    ...
                    foreach ($datas as $data) : ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td>
                                <img src="/img/aset_lainnya/<?= $data['foto_barang'] ?>" alt="<?= $data['foto_barang'] ?>" title="<?= $data['foto_barang'] ?>" width="100">
                            </td>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" href="/aset_lainnya/edit/<?= $data['id']; ?>">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                                <form action="/aset_lainnya/<?= $data['id']; ?>" method="POST" class="d-inline">
                                    <?= csrf_field(); ?>
