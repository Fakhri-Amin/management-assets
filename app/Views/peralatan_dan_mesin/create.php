...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="/peralatan_dan_mesin/save" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <img src="/img/peralatan_dan_mesin/default.png" alt="" class="img-thumbnail img-preview">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="jumlah" name="jumlah" required value="<?= (old('jumlah')) ? old('jumlah') : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="pengguna" class="form-label">Pengguna</label>
                            <input type="text" class="form-control" id="pengguna" name="pengguna" required value="<?= (old('pengguna')) ? old('pengguna') : ''; ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kolom_keterangan" name="kolom_keterangan" required value="<?= (old('kolom_keterangan')) ? old('kolom_keterangan') : ''; ?>">
                        </div>
                    </div>
                    <div class="mt-4 mb-0">
