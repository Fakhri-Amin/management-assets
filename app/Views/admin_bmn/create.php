...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="/admin_bmn/save" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="penyedia_perusahaan" name="penyedia_perusahaan" required value="<?= (old('penyedia_perusahaan')) ? old('penyedia_perusahaan') : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="nama_direktur" class="form-label">Nama Direktur</label>
                            <input type="text" class="form-control" id="nama_direktur" name="nama_direktur" required value="<?= (old('nama_direktur')) ? old('nama_direktur') : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="alamat_penyedia" class="form-label">Alamat Penyedia</label>
                            <input type="text" class="form-control" id="alamat_penyedia" name="alamat_penyedia" required value="<?= (old('alamat_penyedia')) ? old('alamat_penyedia') : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="nomor_siupal" class="form-label">Nomor SIUPAL dan SIUP</label>
                            <input type="text" class="form-control" id="nomor_siupal" name="nomor_siupal" required value="<?= (old('nomor_siupal')) ? old('nomor_siupal') : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="nilai_kontrak" class="form-label">Nilai Kontrak</label>
                            <input type="text" class="form-control" id="nilai_kontrak" name="nilai_kontrak" required value="<?= (old('nilai_kontrak')) ? old('nilai_kontrak') : ''; ?>">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="mb-3">
                            <label for="pekerjaan" class="form-label">Pekerjaan</label>
                            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" required value="<?= (old('pekerjaan')) ? old('pekerjaan') : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="nomor_sp2d" class="form-label">Nomor SP2D</label>
                            <input type="text" class="form-control" id="nomor_sp2d" name="nomor_sp2d" required value="<?= (old('nomor_sp2d')) ? old('nomor_sp2d') : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="jumlah_barang" class="form-label">Jumlah Barang</label>
                            <input type="text" class="form-control" id="jumlah_barang" name="jumlah_barang" required value="<?= (old('jumlah_barang')) ? old('jumlah_barang') : ''; ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="unit_pengguna" name="unit_pengguna" required value="<?= (old('unit_pengguna')) ? old('unit_pengguna') : ''; ?>">
                        </div>
                    </div>
                    <div class="mt-4 mb-0">
